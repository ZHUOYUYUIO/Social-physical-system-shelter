...
agent.newVariableArrayFloat("shortest_value",176, [-1.0] * 176)

# Dijkstra算法需要的变量
agent.newVariableArrayFloat("distances", 176, [999999.0] * 176)  # 距离数组，初始化为无穷大
agent.newVariableArrayInt("visited", 176, [0] * 176)  # 访问标记数组
agent.newVariableArrayInt("previous", 176, [-1] * 176)  # 前驱节点数组
...
for i in range(AGENT_COUNT):
    ...
    if i == 0:
        ...
        agent.setVariableInt("start_vertex_id", 176)  # 从顶点5开始
        agent.setVariableInt("end_vertex_id", 150)   # 到顶点20结束
